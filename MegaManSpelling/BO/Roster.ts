module BO{
  export class Roster{
    public BadGuys:Array<Character> = [
      ...
      new Character("Tornado Man",      "Images/TornadoMan.png",   8, 8, 6),
      new Character("Fire Man",         "Images/FireMan.png",      9, 9, 7),
      new Character("Dragon Man",       "Images/DragonMan.png",    10, 10, 8)];  
